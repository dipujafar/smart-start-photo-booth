      ...
      <div className="w-full bg-[#f8f5f0] py-12 px-4">
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#faf7f2] rounded-xl p-8 flex flex-col items-center text-center border border-primary-gold">
            ...
            <h3 className="xl:text-2xl text-xl font-semibold mb-3">Every guest, every moment.</h3>
          ...
          <div className="bg-[#faf7f2] rounded-xl p-8 flex flex-col items-center text-center  border border-primary-gold">
            ...
            <h3 className="xl:text-2xl text-xl font-semibold mb-3">We make dreams come true.</h3>
          ...
          <div className="bg-[#faf7f2] rounded-xl p-8 flex flex-col items-center text-center  border border-primary-gold">
            ...
            <h3 className="xl:text-2xl text-xl font-semibold mb-3">Cherish your moments.</h3>
