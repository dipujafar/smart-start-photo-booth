    ...
    <div className=" p-4 md:p-8 lg:p-12 max-w-4xl mx-auto">
      <div className="space-y-6 md:space-y-8">
        ...
        <div className="space-y-4 md:space-y-6">
          <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold  leading-tight font-playfair">
...
function FeatureItem({ text }: { text: string }) {
  return (
    <div className="flex items-center gap-2">
      <div className="text-green-600 rounded-full border border-green-600 flex-shrink-0">
